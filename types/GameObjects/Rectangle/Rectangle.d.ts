...
export default class Rectangle {
     ...
     * @memberof Rectangle
     */
    setSize(width: number, height?: number, force?: boolean): Rectangle;
    /**
     * @description
     ...
     * @memberof Rectangle
     */
    refresh(x: number, y: number, width: number, height: number): Rectangle;
    /**
     * @description
     ...
     * @memberof Rectangle
     */
    setRound(topLeft?: number, topRight?: number, bottomLeft?: number, bottomRight?: number): Rectangle;
    round: {
        topLeft: number;
        topRight: number;
        bottomLeft: number;
